...
def createData(years, writeToFile = False, FileName = ''):
    X = []
    Y = []
    if writeToFile:
        xf = open('X' + FileName + '.txt', 'w')
        yf = open('Y' + FileName + '.txt', 'w')
        
    # finding out the existing teams, their names, and formations
